  ...
  return (
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
        ...
        <a
          href="https://fusioncollegenarowal-git-main-aclockwobe.vercel.app/login"
      ...
      <section className="hero section-shell section-shell--hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-ctas">
            ...
            <a href="https://fusioncollegenarowal-git-main-aclockwobe.vercel.app/login" target="_blank" rel="noreferrer" className="btn btn-red">Student LMS ↗</a>
